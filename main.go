...
func newComputerUseMonitor() (*computerUseMonitor, error) {
	...
	if cum.model != audit.AuditBaseLLMCladue35 && cum.model != audit.AuditBaseLLMCladue37 && cum.model != audit.AuditBaseLLMCladue45 && cum.model != audit.AuditBaseLLMGPT4Turbor && cum.model != audit.AuditBaseLLMGPT4o && cum.model != audit.AuditBaseLLMGPTOSS && cum.model != audit.AuditBaseLLMGPTOSSNV {
