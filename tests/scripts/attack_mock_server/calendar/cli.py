...
targetURL = "http://172.17.0.2:9004"
...
def get_day_calendar_events(data, *args):
    ...
    return req.post(targetURL + "/get_day_calendar_events", data = data).text

def create_calendar_event(data, *args):
    ...
    return req.post(targetURL + "/create_calendar_event", data = data).text

def search_calendar_events(data, *args):
    ...
    return req.post(targetURL + "/search_calendar_events", data = data).text

def get_current_day(*args):
    ...
    return req.get(targetURL + "/get_current_day").text

def cancel_calendar_event(data, *args):
    ...
    return req.post(targetURL + "/cancel_calendar_event", data = data).text

def reschedule_calendar_event(data, *args):
    ...
    return req.post(targetURL + "/reschedule_calendar_event", data = data).text

def add_calendar_event_participants(data, *args):
    ...
    return req.post(targetURL + "/add_calendar_event_participants", data = data).text
...
def main():
    parser = argparse.ArgumentParser(
        prog="calendarcli",
        description="A client program to connect the calendar server",
        formatter_class=CustomHelpFormatter
    )

    parser.add_argument("-a", "--action",
                        choices=tools,
                        help="The request action to the calendar server")

    parser.add_argument("-d", "--data", default=None, help="The request data to the calendar server")
